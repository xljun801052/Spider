"""
    一、针对有些具体的网页需要我们登录之后才能浏览，如何爬取？肯定要先模拟登录呀，拥有了登录状态才能进行下去
        1.页面登录，获取登录状态下浏览网页需要发送的cookie，然后request携带cookie进行爬取网页数据

        2.代码直接模拟登录获取登录状态下浏览网页需要的cookie，然后request携带cookie进行爬取网页数据
            ①构造登录headers和data数据
            ②发送请求
            ③保存请求发送后获得的cookie：HTTPCookieProcessor,build_opener两者结合可以构建保存cookie的opener，使用opener的open()方法发送请求

        3.将cookie保存到本地文件中，然后从文件中获取并在发送请求时携带
            ①利用到MozillaCookieJar
...
# 查看京东商品详情信息
url3 = 'https://gia.jd.com/fcf.html?a=7TJI7TceW0Pu7Tce7TZ37Tceg4P5AjE5ABZAZL70S47ZRNFc6Bwt6fNiTB6PwHcPw4wPwH7Xyg6PwHcPwj%3CPwHcPwHcPw4wPwH7*7Tce7TZ37TceWeAewGAe6eAewQF*7Tce7TZ37TceigFPwLiDOgRHwLaDFQ7QOgNHZHwBil6DZ0cxwTABwgAPwHcPw4wPwH7l7Tce7TZ37TcewGDlvH%3CBvH%3CPwHcPw4wPwH7Q7Tce7TZ37TcewSAewGAe6eAewQ8PwHcPwj%3CPwH7pJ0fCvQp4vQZXzSAeRH%3C*wL2xwLixZBcBwGEoJ0ks7Tce7T7L7TceWhwPwHcPwj%3CPwHcPwHcPw4wPwH7QieAewGAB6SAew44tAjZOZ4xfZPpTSjF66k2tS4pc6BJFRAP5T4slfTF5gTfhRPJ1fHZNTBf0SNRIgPZTfjFAffRSTHJwg4jeAjckgTRiRj6kAk35wkpgRNijfNR6RLF%3CwjR1fSAewGAe6eAewd6PwHcPwj%3CPwH7ySjPIgPPgTN30fHAtgLFiRk3KgAFfSkFhTA7K6PcBfAot6jJTSkbIg%3CN1TkZAAAk6ZPZvgAbIfLJLAj9TTjxyAk3FA4PvAjCg6jRySeAewGAe6eAewdNp7Tce7TZ37Tce7Tce7T7L7TceydRG7Tce7TZ37TcewHckR4R%3CwPb3ZApww4ffT%3CfFSjJyZj4eRHJwZANvALJ6APFKA4ESA4Ec6AN7ZANffLJTwP3ZRAZhZkN5TkPcRjJN6kRRS4kATkN66TZAALFKZjWeZHZ6AH77T%3C%3ClfBJ56f4ef4kcSSAewGAtR2/'
headers = {
...
# with open('e:\\jdcontent.txt','wb') as f:
